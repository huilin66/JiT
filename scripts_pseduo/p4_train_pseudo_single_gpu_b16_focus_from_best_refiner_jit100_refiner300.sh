...
JIT_OUTPUT_DIR=${JIT_OUTPUT_DIR:-${OUT_ROOT}/p4_b16_focus_2scene_from_best_refiner_jit_ft_100ep_single_gpu/16}
REFINER_OUTPUT_DIR=${REFINER_OUTPUT_DIR:-${OUT_ROOT}/p4_b16_focus_2scene_from_best_refiner_refiner_300ep_single_gpu/16}
...
echo "============================================================"
echo "[P4 pseudo single GPU] B16 focus2scene from best refiner: JIT 100ep + refiner 300ep"
