...
#
# Estimate from prior runs: B16 refiner 50 epochs ~= 2h on 1x5090, so 75 epochs
...
OUTPUT_DIR=${OUTPUT_DIR:-run/train_pseudo/b16_focus_2scene_refiner_c1_pseudo_ft_75ep_1x5090/16}
...
echo "============================================================"
echo "[Pseudo 1x5090] B16 focus2scene refiner, target ~=3h"
...
echo "Pseudo B16 focus2scene refiner training finished."
