...
#     For reproducibility this script uses one visible GPU and launches
#     main_jit.py directly, without torchrun/distributed training.
...
JIT_OUTPUT_DIR=${JIT_OUTPUT_DIR:-${OUT_ROOT}/p2_b16_dn_blur_4scene_jit_best_base_hparams_single_gpu/16}
REFINER_OUTPUT_DIR=${REFINER_OUTPUT_DIR:-${OUT_ROOT}/p2_b16_dn_blur_4scene_refiner_c1_from_jit_last_single_gpu/16}
...
echo "============================================================"
echo "[P2 pseudo single GPU] B16 dn_blur_4scene JIT + refiner"
