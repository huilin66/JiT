...
#OUTPUT_DIR=/scrinvme/huilin/bdd/cp_data/raindrop_remove_2026/output/JiT-B-raindrop01/16
#
#CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port=29501 main_jit.py \
#--model JiT-B/16 \
#--proj_dropout 0.0 \
#--img_size 256 \
...
#
#
#OUTPUT_DIR=/scrinvme/huilin/bdd/cp_data/raindrop_remove_2026/output/JiT-B-raindrop02/16
#
#CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port=29502 main_jit.py \
#--model JiT-B/16 \
#--proj_dropout 0.0 \
#--img_size 256 \
#--batch_size 64 --lr 5e-5 \
...
OUTPUT_DIR=/scrinvme/huilin/bdd/cp_data/raindrop_remove_2026/output/JiT-B-raindrop03/16

CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port=29503 main_jit.py \
--model JiT-B/16 \
--proj_dropout 0.0 \
--img_size 256 \
--batch_size 64 --lr 5e-5 \
...
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port=29504 main_jit.py \
--model JiT-B/16 \
--proj_dropout 0.0 \
--img_size 256 \
--batch_size 64 --lr 5e-5 \
